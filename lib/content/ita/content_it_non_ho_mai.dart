...
class ContentItNonHoMai {
  ...
  (
  text: 'usato la scusa "domani mi sveglio presto" per andarmene da una festa',
  tone: ContentTone.normal,
  ),
  (
  ...
  (text: 'messo "mi piace" a un post senza averlo letto', tone: ContentTone.normal),
  (
  ...
  (
  text: 'fatto la walk of shame con ancora addosso i vestiti della sera prima',
  tone: ContentTone.mix,
  ),
  (
  ...
  (
  text: 'avuto un match senza scrivere mai per paura di fare il primo passo',
  tone: ContentTone.mix,
  ),
  (
  text: 'fatto la prima mossa e ricevuto un rifiuto',
  tone: ContentTone.mix,
  ),
  (
  ...
  (
  text:
  'accettato un massaggio sapendo benissimo come sarebbe finito',
  tone: ContentTone.mix,
  ),
  (
  ...
  (
  text: 'tenuto uno spazzolino di riserva per un ospite che si fermava a dormire',
  tone: ContentTone.mix,
  ),
  // ------------------------------------------------------- hot
  ...
  (
  text: 'fatto sesso nel camerino di un negozio',
  tone: ContentTone.hot,
  ),
  (
  ...
  (
  text: 'fatto sesso sul pavimento perché non riuscivamo ad arrivare al letto',
  tone: ContentTone.hot,
  ),
  ...
  (
  text: 'fatto un gioco di ruolo erotico a letto',
  tone: ContentTone.hot,
  ),
  (
  ...
  (
  text: 'fatto sesso con due persone diverse nell'arco di ventiquattro ore',
  tone: ContentTone.hot,
  ),
  (
  ...
  (
  text: 'fatto sesso con la luce accesa davanti allo specchio per guardarmi',
  tone: ContentTone.hot,
  ),
  (
  ...
  (text: 'fatto sesso in una tenda durante un campeggio', tone: ContentTone.hot),
  (
  ...
  (
  text: 'provato il wax play o il temperature play',
  tone: ContentTone.hot,
  ),
  (
  ...
  (
  text: 'fatto masturbazione reciproca guardandoci',
  tone: ContentTone.hot,
  ),
  (
