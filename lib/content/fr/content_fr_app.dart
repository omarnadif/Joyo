class ContentFrApp {
  ...
  static const Map<String, String> ui = {
    ...
    'paywall.best_value': 'Le plus choisi',
    'paywall.feat_modes': 'Modes Mix et Hot',
    'paywall.feat_rounds': 'Parties plus longues',
    ...
    'settings.notifications_desc': 'Rappels et nouveautés',
    'notif.comeback_1_title': 'Tes amis t\'attendent 🎉',
    'notif.comeback_1_body': 'Ça fait longtemps ? Rouvre Joyo !',
    'notif.comeback_2_title': 'Tu nous manques 👀',
    'notif.comeback_2_body': "Le groupe n'est pas pareil sans toi.",
    'notif.comeback_3_title': 'La chaise vide, c\'est la tienne 🃏',
    'notif.comeback_3_body': 'Reviens à table, on rejoue !',
    'notif.comeback_4_title': 'Une revanche ? 🏆',
    'notif.comeback_4_body': 'La dernière partie est restée en travers. Reviens gagner.',
    'notif.comeback_5_title': 'Qui commande ce soir ? 🔥',
    'notif.comeback_5_body': 'Ouvre Joyo et découvre-le avec un nouveau défi.',
    'notif.comeback_6_title': 'Prêt à te rattraper ? 🎯',
    'notif.comeback_6_body': 'Une partie rapide et tu es quitte.',
    'notif.comeback_7_title': 'Soirée Joyo ? 🌙',
    'notif.comeback_7_body': 'Rassemble le groupe, 5 minutes suffisent.',
    'notif.comeback_8_title': 'Il ne manque que le jeu 🍕',
    'notif.comeback_8_body': 'Amis, canapé, Joyo. On commence ?',
    'settings.manage_sub': 'Gérer l\'abonnement',
    'settings.manage_sub_desc': 'Renouveler, changer ou résilier',
    'settings.restore': 'Restaurer les achats',
    'settings.rate': 'Noter l\'appli',
    'settings.rate_desc': 'Laissez-nous un avis',
    'settings.contact': 'Nous contacter',
    'settings.contact_desc': 'Écrivez-nous pour de l\'aide ou un retour',
